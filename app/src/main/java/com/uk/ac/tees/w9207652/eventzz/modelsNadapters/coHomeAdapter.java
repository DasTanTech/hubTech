...
public class coHomeAdapter extends RecyclerView.Adapter<coHomeAdapter.home_VH> {

    private List<eventModel> eventModelList;
    private Context context;

    public coHomeAdapter(List<eventModel> eventModelList, Context context) {
    ...
    public home_VH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new home_VH(view);
    }

    @Override
    public void onBindViewHolder(@NonNull home_VH holder, int position) {
